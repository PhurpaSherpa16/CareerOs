...
export default function CompanyAppliedSkeleton() {
  return (
    <div className="w-full space-y-4 animate-pulse p-1 h-70 flex flex-col justify-between">
      ...
      <div className="flex items-end justify-between gap-3 h-50 pt-4 px-2">
        {[85, 65, 90, 45, 75, 55, 40, 25].map((height, i) => (
          <div key={i} className="flex-1 flex flex-col items-center gap-2 h-full justify-end">
            <div className="w-4 h-3 bg-slate-200 rounded"></div>
            <div className="w-full max-w-8 bg-slate-100 rounded-t-lg flex items-end overflow-hidden" style={{ height: `${height}%` }}>
